...
export default class Auth extends Component {
  ...
  loginHandler = async () => {
    ...
    try {
      const response = await axios.post('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCZx7N4U87TE_ThjJyWOn5wrZlONYAAPcw', authData)
